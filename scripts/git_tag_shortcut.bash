...
function HELP {
  ...
  echo -e "Example: ${BOLD}$SCRIPT \"Release for whatever\" release_2021_06\\n"
  exit 1
}
...
# Push current repo
echo "If you like to push the tag run this: \"git push --tags\""
#git push --tags

# Add tag to submodules
git submodule foreach git tag -m "$tagNameMsg" $tagName
# Push submodule repo
echo "If you like to push the tag to all submodule run this: \"git submodule foreach git push --tags\""
